        ...
        holder.rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedView != null) {
                    holder.monthView.setTextColor(timelineView.getResources().getColor(R.color.black));
                    holder.dateView.setTextColor(timelineView.getResources().getColor(R.color.black));
                    holder.dayView.setTextColor(timelineView.getResources().getColor(R.color.black));
                    selectedView.setBackground(timelineView.getResources().getDrawable(R.drawable.background_shape_unselected));
                    //  selectedView.setBackground(null);
                }
                if (!isDisabled) {
                    v.setBackground(timelineView.getResources().getDrawable(R.drawable.background_shape));
                    holder.monthView.setTextColor(timelineView.getResources().getColor(R.color.blue_1));
                    holder.dateView.setTextColor(timelineView.getResources().getColor(R.color.blue_1));
                    holder.dayView.setTextColor(timelineView.getResources().getColor(R.color.blue_1));
                    ...
                    holder.dateView.setTextColor(timelineView.getResources().getColor(R.color.black));
                    holder.dayView.setTextColor(timelineView.getResources().getColor(R.color.black));
                    v.setBackground(timelineView.getResources().getDrawable(R.drawable.background_shape_unselected));
                    if (listener != null)
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        boolean bind(int month, int day, int dayOfWeek, int year, int position) {
            ...
            if (selectedPosition == position) {
                monthView.setTextColor(timelineView.getResources().getColor(R.color.blue_1));
                dateView.setTextColor(timelineView.getResources().getColor(R.color.blue_1));
                dayView.setTextColor(timelineView.getResources().getColor(R.color.blue_1));
                rootView.setBackground(timelineView.getResources().getDrawable(R.drawable.background_shape));
                selectedView = rootView;
            } else {
                // rootView.setBackground(null);
                monthView.setTextColor(timelineView.getResources().getColor(R.color.black));
                dateView.setTextColor(timelineView.getResources().getColor(R.color.black));
                dayView.setTextColor(timelineView.getResources().getColor(R.color.black));

                rootView.setBackground(timelineView.getResources().getDrawable(R.drawable.background_shape_unselected));
            }
