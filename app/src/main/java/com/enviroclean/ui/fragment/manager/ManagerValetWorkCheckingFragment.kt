 ...
 */
class ManagerValetWorkCheckingFragment : BaseFragment<ManagerVelatesWorkCheckingViewModel>(),
        ...
        if (data!!.qrType == AppConstants.REMAINING) {
            ...
            if (ContextCompat.checkSelfPermission(context!!, Manifest.permission.CAMERA)
                ...
                ActivityCompat.requestPermissions(
                    context as ManagerHomeActivity, arrayOf<String>(
        ...
        view?.let {
            when (it.id) {
                ...
                R.id.tvViolationCount -> {
                    if (WITHOUT_CHECK == 2) {
                        if( prefs.checkingResponse!!.result!!.commVioCount!=0){
                            startActivity(ViolationReportListActivity.newInstance(context!!, prefs.checkingResponse!!.result!!.commId.toString(),
    ...
    companion object {
        ...
        var WITHOUT_CHECK = 1
        fun newInstance(): ManagerValetWorkCheckingFragment {
            val bundle = Bundle()
            val fragment = ManagerValetWorkCheckingFragment()
    ...
    private fun socketRegister() {
        ...
        AppUtils.startSocketConnection(
            ...
            context!!,
            this@ManagerValetWorkCheckingFragment, this@ManagerValetWorkCheckingFragment
        )
    ...
    private val observeCummintyList = Observer<CheckIngResponse1> {
        ...
        val abc=prefs.checkingResponse
    }
    ...
    private fun addReminder(reminder: Reminder) {
        getRepository().add(reminder,
            success = {
                val reminder1 =
                    Reminder(area_id = null, latLng = null, radius = null, message = null)
                ...
                if (mQrType == 2) {
                    ...
                    if (1 == mType || directViewValtes) {
                        ...
                        binding.tvCommunityCount.text =
                            prefsCheckingResponse.result!!.commRemainCount.toString()
                        ...
                        for (i in 0 until prefsCheckingResponse!!.result!!.commQrcodes.size) {
                            ...
                            if (prefsCheckingResponse.result.commQrcodes[i]!!.qrId == mQRId) {
                                ...
                                prefsCheckingResponse.result.commQrcodes[i]!!.qrType = mQRStatus
                                prefsCheckingResponse.result.commQrcodes[i]!!.username = mName
